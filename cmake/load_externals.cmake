...
if(CMAKE_CUDA_COMPILER)
  ...
  if(_CUDA_MAJOR_VERSION GREATER_EQUAL 13)
    set(ORT_CUDA_SUFFIX "-gpu_cuda13")
  else()
    set(ORT_CUDA_SUFFIX "-gpu_cuda12")
  endif()
else()
  set(ORT_CUDA_SUFFIX "")
...
if(ORT_VERSION_LENGTH LESS_EQUAL 12)
  ...
  elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|arm64")
    set(ORT_NAME "onnxruntime-linux-aarch64-${ORT_VERSION}.tgz")
    set(ORT_FOLD "onnxruntime-linux-aarch64-${ORT_VERSION}")
  else()
