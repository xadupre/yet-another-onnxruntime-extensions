...
if(CMAKE_CUDA_COMPILER)
  ...
  if(NOT _CUDA_MAJOR_VERSION)
    # Default to CUDA 13, the version targeted by ORT 1.25.x GPU packages.
    set(_CUDA_MAJOR_VERSION 13)
    message(WARNING "ORT - could not detect CUDA major version from nvcc output; defaulting to cuda${_CUDA_MAJOR_VERSION}. Set ORT_VERSION to a local path to override the package selection.")
  endif()
  set(ORT_CUDA_SUFFIX "-gpu-cuda${_CUDA_MAJOR_VERSION}")
