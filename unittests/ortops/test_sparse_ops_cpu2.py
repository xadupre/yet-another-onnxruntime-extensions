...
The shared library ``yaourt/ortops/sparse/cpu/libortops_fused_kernel_cpu2.so`` must be
...
if _SYSTEM == "Windows":
    _LIB_NAME = "ortops_fused_kernel_cpu2.dll"
elif _SYSTEM == "Darwin":
    _LIB_NAME = "libortops_fused_kernel_cpu2.dylib"
else:
    _LIB_NAME = "libortops_fused_kernel_cpu2.so"
